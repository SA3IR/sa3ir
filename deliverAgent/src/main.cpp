...
/** \mainpage RoboComp::deliver
 *
 * \section intro_sec Introduction
 *
 * The deliver component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/deliver --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class deliver : public RoboComp::Application
{
public:
	deliver (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::deliver::run(int argc, char* argv[])
{

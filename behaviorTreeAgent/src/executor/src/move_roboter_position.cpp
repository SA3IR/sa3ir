...
MoveRoboterPosition::MoveRoboterPosition(SpecificWorker* sw, const std::string& instance_name,
...
BT::NodeStatus MoveRoboterPosition::tick() {
    
    sw->startNavigationAction("move");

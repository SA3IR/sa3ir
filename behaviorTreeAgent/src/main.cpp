...
/** \mainpage RoboComp::behaviorTree
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/behaviorTree --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class behaviorTree : public RoboComp::Application
{
public:
	behaviorTree (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::behaviorTree::run(int argc, char* argv[])
{

...
/** \mainpage RoboComp::contextProvider
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/contextProvider --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class contextProvider : public RoboComp::Application
{
public:
	contextProvider (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::contextProvider::initialize()
{
...
int ::contextProvider::run(int argc, char* argv[])
{

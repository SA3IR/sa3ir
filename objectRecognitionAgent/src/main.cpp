...
/** \mainpage RoboComp::objectRecognition
 *
 * \section intro_sec Introduction
 *
 * The objectRecognition component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/objectRecognition --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class objectRecognition : public RoboComp::Application
{
public:
	objectRecognition (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::objectRecognition::run(int argc, char* argv[])
{

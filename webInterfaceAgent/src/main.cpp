...
/** \mainpage RoboComp::webInterfaceAgent
 *
 * \section intro_sec Introduction
 *
 * The webInterfaceAgent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/webInterfaceAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class webInterfaceAgent : public RoboComp::Application
{
public:
	webInterfaceAgent (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::webInterfaceAgent::initialize()
{
...
int ::webInterfaceAgent::run(int argc, char* argv[])
{

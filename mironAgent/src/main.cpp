 ...
 *
 * Just: "${PATH_TO_BINARY}/miron --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class miron : public RoboComp::Application
{
public:
	miron (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::miron::run(int argc, char* argv[])
{
